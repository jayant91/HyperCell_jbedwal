...
class storeSeqDP extends Module{
	...
	val storeSeqMemConfig 			= Module(new memConfig(32, seqMemAddrWidth, seqMemWidth))
	...
	val baseAddrMemConfig			= Module(new memConfig(33, addrLkupIndexWidth, baseMemWidth))
	...
	val loopOffsetMemConfig			= Module(new memConfig(34, addrLkupIndexWidth, loopOffsetMemWidth))
	...
	val spillOffsetMemConfig		= Module(new memConfig(35, addrLkupIndexWidth, spillMemWidth))
